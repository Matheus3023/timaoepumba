...
export const ADMIN_NAV_LINKS: { href: string; label: string; section: AdminSection }[] = [
  ...
  { href: "/admin/usuarios", label: "Usuários / CRM", section: "usuarios" },
  { href: "/admin/segmentos", label: "Segmentos", section: "segmentos" },
  { href: "/admin/analises", label: "Análises", section: "analises" },
  { href: "/admin/comunidade", label: "Moderação", section: "comunidade" },
  { href: "/admin/dados-esportivos", label: "Dados esportivos", section: "dados_esportivos" },
  { href: "/admin/competicoes", label: "Competições permitidas", section: "competicoes" },
  ...
  { href: "/admin/relatorios/retencao", label: "Retenção", section: "relatorios" },
  { href: "/admin/relatorios/comunicacoes", label: "Comunicações", section: "relatorios" },
