---
name: 24-copy-revisar
description: "Revisão e melhoria de textos de marketing existentes, edição, polimento e refinamento de copy. Use quando já tiver um texto e quiser melhorar, revisar, apertar a mensagem ou corrigir tom. Para escrever copy do zero, use /23-copy."
metadata:
  version: 1.1.0
---
